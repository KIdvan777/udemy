<?php get_header(); ?>
		...
		<div id="fh5co-search-map">
			...
			<div class="map" style="background-image: url(<?= get_template_directory_uri() .'/assets/images/cover_bg_1.jpg'?>);">
			</div>
		</div>
		...
		<div id="fh5co-popular-properties" class="fh5co-section-gray">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<a href="#" class="fh5co-property" style="background-image: url(<?= get_template_directory_uri() . '/assets/images/property-1.jpg'?>);">
							<span class="status">Sale</span>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="fh5co-property" style="background-image: url(<?= get_template_directory_uri() . '/assets/images/property-2.jpg'?>);">
							<span class="status">Rent</span>
							<div class="prop-details">
				...
				<div class="row">
					<div class="col-sm-3 text-center animate-box" data-animate-effect="fadeIn">
						<div class="fh5co-staff">
							<img class="img-responsive" src="<?= get_template_directory_uri() . '/assets/images/user-1.jpg'?>" alt="Free HTML5 Templates by freeHTML5.co">
							<h3>Jean Smith</h3>
